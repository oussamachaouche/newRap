...
export interface ApiCommuneReparateurCommuneReparateur
  extends Schema.CollectionType {
  collectionName: 'commune_reparateurs';
  info: {
    singularName: 'commune-reparateur';
    pluralName: 'commune-reparateurs';
    displayName: 'Commune Reparateur';
    description: '';
  };
  options: {
  ...
  attributes: {
    nomCommune: Attribute.String;
    wilaya: Attribute.Relation<
      'api::commune-reparateur.commune-reparateur',
      'manyToOne',
      'api::wilaya.wilaya'
    >;
    createdAt: Attribute.DateTime;
...
export interface ApiReparateurReparateur extends Schema.CollectionType {
  ...
  attributes: {
    ...
    wilaya: Attribute.Relation<
      ...
      'api::wilaya.wilaya'
    >;
    commune_reparateur: Attribute.Relation<
      'api::reparateur.reparateur',
      'oneToOne',
      'api::commune-reparateur.commune-reparateur'
    >;
    ...
    NumeroRegistreComerce: Attribute.String;
    regimeFiscal: Attribute.String;
    Ristourne: Attribute.String;
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::commune-reparateur.commune-reparateur': ApiCommuneReparateurCommuneReparateur;
      'api::reparateur.reparateur': ApiReparateurReparateur;
